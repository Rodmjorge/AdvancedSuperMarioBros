...
public interface LayerMaskInterface
{
    ...
    public static int itemLayer { get { return LayerMask.NameToLayer("Items"); } }
    ...
    public static LayerMask itemed { get { return 1 << itemLayer; } }
    public static LayerMask enemyBlock { get { return justBloked + enemy; } }
    public static LayerMask enemyBlockT { get { return enemyBlock + tBloked; } }
